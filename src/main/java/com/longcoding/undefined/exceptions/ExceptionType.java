...
public enum ExceptionType {
    ...
    E_1001_APIKEY_IS_NOT_FOUND("1001", HttpStatus.UNAUTHORIZED),
    E_1002_API_IS_NOT_EXIST("1002", HttpStatus.UNAUTHORIZED),
    ...
    E_1005_APIKEY_IS_INVALID("1005", HttpStatus.UNAUTHORIZED),
